...
/*
	...
	It has these top-level messages:
		...
		Value
		CustomizedResource
		CustomizedResourceRequirements
*/
package api
...
type NodeDescription struct {
	...
	// Total customized ressource
	CustomizedResources []*CustomizedResource `protobuf:"bytes,5,rep,name=customized_resources,json=customizedResources" json:"customized_resources,omitempty"`
}
...
type RestartPolicy struct {
	...
	Delay *google_protobuf2.Duration `protobuf:"bytes,2,opt,name=delay" json:"delay,omitempty"`
	...
	// Note: can't use stdduration because this field needs to be nullable.
	Window *google_protobuf2.Duration `protobuf:"bytes,4,opt,name=window" json:"window,omitempty"`
}
...
type UpdateConfig struct {
	...
	// be used.
	// Note: can't use stdduration because this field needs to be nullable.
	Monitor *google_protobuf2.Duration `protobuf:"bytes,4,opt,name=monitor" json:"monitor,omitempty"`
...
type UpdateStatus struct {
	...
	StartedAt *google_protobuf1.Timestamp `protobuf:"bytes,2,opt,name=started_at,json=startedAt" json:"started_at,omitempty"`
	// CompletedAt is the time at which the update completed successfully,
	// paused, or finished rolling back.
	// Note: can't use stdtime because this field is nullable.
	CompletedAt *google_protobuf1.Timestamp `protobuf:"bytes,3,opt,name=completed_at,json=completedAt" json:"completed_at,omitempty"`
...
type CAConfig struct {
	...
	// Note: can't use stdduration because this field needs to be nullable.
	NodeCertExpiry *google_protobuf2.Duration `protobuf:"bytes,1,opt,name=node_cert_expiry,json=nodeCertExpiry" json:"node_cert_expiry,omitempty"`
...
type DispatcherConfig struct {
	...
	// dispatcher.
	// Note: can't use stdduration because this field needs to be nullable.
	HeartbeatPeriod *google_protobuf2.Duration `protobuf:"bytes,1,opt,name=heartbeat_period,json=heartbeatPeriod" json:"heartbeat_period,omitempty"`
}
...
type BlacklistedCertificate struct {
	...
	// Note: can't use stdtime because this field is nullable.
	Expiry *google_protobuf1.Timestamp `protobuf:"bytes,1,opt,name=expiry" json:"expiry,omitempty"`
}
...
type HealthConfig struct {
	...
	// number of retries.
	StartPeriod *google_protobuf2.Duration `protobuf:"bytes,5,opt,name=start_period,json=startPeriod" json:"start_period,omitempty"`
}
...
func (m *NodeDescription) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.CustomizedResources != nil {
		m.CustomizedResources = make([]*CustomizedResource, len(o.CustomizedResources))
		for i := range m.CustomizedResources {
			m.CustomizedResources[i] = &CustomizedResource{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.CustomizedResources[i], o.CustomizedResources[i])
		}
	}
...
func (m *RestartPolicy) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.Delay != nil {
		m.Delay = &google_protobuf2.Duration{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Delay, o.Delay)
	}
	if o.Window != nil {
		m.Window = &google_protobuf2.Duration{}
...
func (m *UpdateConfig) CopyFrom(src interface{}) {
	...
	*m = *o
	github_com_docker_swarmkit_api_deepcopy.Copy(&m.Delay, &o.Delay)
	if o.Monitor != nil {
		m.Monitor = &google_protobuf2.Duration{}
...
func (m *UpdateStatus) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.StartedAt != nil {
		m.StartedAt = &google_protobuf1.Timestamp{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.StartedAt, o.StartedAt)
	}
	if o.CompletedAt != nil {
		m.CompletedAt = &google_protobuf1.Timestamp{}
...
func (m *CAConfig) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.NodeCertExpiry != nil {
		m.NodeCertExpiry = &google_protobuf2.Duration{}
...
func (m *DispatcherConfig) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.HeartbeatPeriod != nil {
		m.HeartbeatPeriod = &google_protobuf2.Duration{}
...
func (m *BlacklistedCertificate) CopyFrom(src interface{}) {
	...
	*m = *o
	if o.Expiry != nil {
		m.Expiry = &google_protobuf1.Timestamp{}
...
func (m *HealthConfig) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.StartPeriod != nil {
		m.StartPeriod = &google_protobuf2.Duration{}
...
func (m *NodeDescription) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CustomizedResources) > 0 {
		for _, msg := range m.CustomizedResources {
			dAtA[i] = 0x2a
			i++
			i = encodeVarintTypes(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *NodeDescription) Size() (n int) {
	...
	if len(m.CustomizedResources) > 0 {
		for _, e := range m.CustomizedResources {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (this *NodeDescription) String() string {
	...
	s := strings.Join([]string{`&NodeDescription{`,
		...
		`CustomizedResources:` + strings.Replace(fmt.Sprintf("%v", this.CustomizedResources), "CustomizedResource", "CustomizedResource", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *RestartPolicy) String() string {
	...
	s := strings.Join([]string{`&RestartPolicy{`,
		...
		`Delay:` + strings.Replace(fmt.Sprintf("%v", this.Delay), "Duration", "google_protobuf2.Duration", 1) + `,`,
		`MaxAttempts:` + fmt.Sprintf("%v", this.MaxAttempts) + `,`,
		`Window:` + strings.Replace(fmt.Sprintf("%v", this.Window), "Duration", "google_protobuf2.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *UpdateConfig) String() string {
	...
	s := strings.Join([]string{`&UpdateConfig{`,
		...
		`Delay:` + strings.Replace(strings.Replace(this.Delay.String(), "Duration", "google_protobuf2.Duration", 1), `&`, ``, 1) + `,`,
		`FailureAction:` + fmt.Sprintf("%v", this.FailureAction) + `,`,
		`Monitor:` + strings.Replace(fmt.Sprintf("%v", this.Monitor), "Duration", "google_protobuf2.Duration", 1) + `,`,
...
func (this *UpdateStatus) String() string {
	...
	s := strings.Join([]string{`&UpdateStatus{`,
		`State:` + fmt.Sprintf("%v", this.State) + `,`,
		`StartedAt:` + strings.Replace(fmt.Sprintf("%v", this.StartedAt), "Timestamp", "google_protobuf1.Timestamp", 1) + `,`,
		`CompletedAt:` + strings.Replace(fmt.Sprintf("%v", this.CompletedAt), "Timestamp", "google_protobuf1.Timestamp", 1) + `,`,
		`Message:` + fmt.Sprintf("%v", this.Message) + `,`,
		`}`,
	}, "")
	return s
...
func (this *CAConfig) String() string {
	...
	s := strings.Join([]string{`&CAConfig{`,
		`NodeCertExpiry:` + strings.Replace(fmt.Sprintf("%v", this.NodeCertExpiry), "Duration", "google_protobuf2.Duration", 1) + `,`,
...
func (this *DispatcherConfig) String() string {
	...
	s := strings.Join([]string{`&DispatcherConfig{`,
		`HeartbeatPeriod:` + strings.Replace(fmt.Sprintf("%v", this.HeartbeatPeriod), "Duration", "google_protobuf2.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *BlacklistedCertificate) String() string {
	...
	s := strings.Join([]string{`&BlacklistedCertificate{`,
		`Expiry:` + strings.Replace(fmt.Sprintf("%v", this.Expiry), "Timestamp", "google_protobuf1.Timestamp", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *HealthConfig) String() string {
	...
	s := strings.Join([]string{`&HealthConfig{`,
		...
		`Interval:` + strings.Replace(fmt.Sprintf("%v", this.Interval), "Duration", "google_protobuf2.Duration", 1) + `,`,
		...
		`StartPeriod:` + strings.Replace(fmt.Sprintf("%v", this.StartPeriod), "Duration", "google_protobuf2.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *NodeDescription) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomizedResources", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CustomizedResources = append(m.CustomizedResources, &CustomizedResource{})
			if err := m.CustomizedResources[len(m.CustomizedResources)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorTypes = []byte{
	...
	,
	...
	,
}
