...
type TaskSpec struct {
	...
	CustomizedResources []*CustomizedResourceRequirements `protobuf:"bytes,11,rep,name=customized_resources,json=customizedResources" json:"customized_resources,omitempty"`
}
...
type ContainerSpec struct {
	...
	StopGracePeriod *google_protobuf2.Duration `protobuf:"bytes,9,opt,name=stop_grace_period,json=stopGracePeriod" json:"stop_grace_period,omitempty"`
...
func (m *TaskSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.CustomizedResources != nil {
		m.CustomizedResources = make([]*CustomizedResourceRequirements, len(o.CustomizedResources))
		for i := range m.CustomizedResources {
			m.CustomizedResources[i] = &CustomizedResourceRequirements{}
...
func (m *ContainerSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.StopGracePeriod != nil {
		m.StopGracePeriod = &google_protobuf2.Duration{}
...
func (this *TaskSpec) String() string {
	...
	s := strings.Join([]string{`&TaskSpec{`,
		...
		`CustomizedResources:` + strings.Replace(fmt.Sprintf("%v", this.CustomizedResources), "CustomizedResourceRequirements", "CustomizedResourceRequirements", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`StopGracePeriod:` + strings.Replace(fmt.Sprintf("%v", this.StopGracePeriod), "Duration", "google_protobuf2.Duration", 1) + `,`,
...
func (m *TaskSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.CustomizedResources = append(m.CustomizedResources, &CustomizedResourceRequirements{})
...
var fileDescriptorSpecs = []byte{
	...
	,
}
