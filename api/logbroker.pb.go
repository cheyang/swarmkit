...
type LogSubscriptionOptions struct {
	...
	Since *google_protobuf1.Timestamp `protobuf:"bytes,4,opt,name=since" json:"since,omitempty"`
}
...
func (this *LogSubscriptionOptions) String() string {
	...
	s := strings.Join([]string{`&LogSubscriptionOptions{`,
		...
		`Since:` + strings.Replace(fmt.Sprintf("%v", this.Since), "Timestamp", "google_protobuf1.Timestamp", 1) + `,`,
		`}`,
	}, "")
	return s
}
